...
WHERE
	...
	(SD3010.D3_DOC LIKE 'INVENT') AND --CONSIDERA REGULARIZAÇÕES DE INVENTÁRIO
	(SD3010.D3_FILIAL=@filial) AND (SD3010.D3_LOCAL=@armazem) AND
	(SD3010.D3_EMISSAO>@dateFrom) AND (SD3010.D3_EMISSAO<=@dateTo)
